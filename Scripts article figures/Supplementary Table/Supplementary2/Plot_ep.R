...
setwd("~/Dropbox/Colaboracoes/IC_Sofia/versao2021")
...
####
#propagulo N=b#####
setwd("~/Dropbox/Colaboracoes/IC_Sofia/versao2021/VariandoPropagulo")
obj1=read.table("contagem_probabilidade1.txt",header=FALSE)
#obj2=read.table("contagem_probabilidade2.txt",header=FALSE)
obj3=read.table("contagem_probabilidade.txt",header=FALSE)
...
#propagulo N=1#####
setwd("~/Dropbox/Colaboracoes/IC_Sofia/versao2021/VariandoPropagulo/N=1")
obj1=read.table("contagem_probabilidade1.txt",header=FALSE)
#obj2=read.table("contagem_probabilidade2.txt",header=FALSE)
